...
GattPeripheral.prototype.setServices = function(services) {
...
GattPeripheral.prototype.setAclStream = function(aclStream) {
  this._mtu = 203;
  this._preparedWriteRequest = null;
...
GattPeripheral.prototype.onAclStreamData = function(cid, data) {
  if (cid !== ATT_CID) {
    return;
  }
...
GattPeripheral.prototype.onAclStreamEnd = function() {
  this._aclStream.removeListener('data', this.onAclStreamDataBinded);
  this._aclStream.removeListener('end', this.onAclStreamEndBinded);
};

GattPeripheral.prototype.send = function(data) {
  debug('send: ' + data.toString('hex'));
  this._aclStream.write(ATT_CID, data);
};

GattPeripheral.prototype.errorResponse = function(opcode, handle, status) {
...
GattPeripheral.prototype.handleRequest = function(request) {
  debug('GattPeripheral handing request: ' + request.toString('hex'));
...
GattPeripheral.prototype.handleMtuRequest = function(request) {
...
GattPeripheral.prototype.handleFindInfoRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleFindByTypeRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleReadByGroupRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleReadByTypeRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleReadOrReadBlobRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleWriteRequestOrCommand = function(request) {
  var response = null;
...
GattPeripheral.prototype.handlePrepareWriteRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleExecuteWriteRequest = function(request) {
  var response = null;
...
GattPeripheral.prototype.handleConfirmation = function(request) {
