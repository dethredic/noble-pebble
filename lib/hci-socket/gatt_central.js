...
var GattCentral = function(address, aclStream) {
...
util.inherits(GattCentral, events.EventEmitter);

GattCentral.prototype.onAclStreamData = function(cid, data) {
  if (cid !== ATT_CID) {
    return;
  }
  ...
  if (this._currentCommand && data.toString('hex') === this._currentCommand.buffer.toString('hex')) {
    ...
    // console.log(this._address + ': replying with REQ_NOT_SUPP to 0x' + requestType.toString(16));
...
GattCentral.prototype.onAclStreamEncrypt = function(encrypt) {
  console.log('onAclStreamEncrypt');
  if (encrypt) {
    this._security = 'medium';
...
GattCentral.prototype.onAclStreamEncryptFail = function() {

};

GattCentral.prototype.onAclStreamEnd = function() {
...
GattCentral.prototype.writeAtt = function(data) {
  debug(this._address + ': write: ' + data.toString('hex'));

  this._aclStream.write(ATT_CID, data);
};

GattCentral.prototype.errorResponse = function(opcode, handle, status) {
...
GattCentral.prototype._queueCommand = function(buffer, callback, writeCallback) {
...
GattCentral.prototype.mtuRequest = function(mtu) {
...
GattCentral.prototype.readByGroupRequest = function(startHandle, endHandle, groupUuid) {
...
GattCentral.prototype.readByTypeRequest = function(startHandle, endHandle, groupUuid) {
  var buf = new Buffer(7);
...
GattCentral.prototype.readRequest = function(handle) {
  var buf = new Buffer(3);
...
GattCentral.prototype.readBlobRequest = function(handle, offset) {
  var buf = new Buffer(5);
...
GattCentral.prototype.findInfoRequest = function(startHandle, endHandle) {
  var buf = new Buffer(5);
...
GattCentral.prototype.writeRequest = function(handle, data, withoutResponse) {
...
GattCentral.prototype.handleConfirmation = function() {
...
GattCentral.prototype.exchangeMtu = function(mtu) {
...
GattCentral.prototype.discoverServices = function(uuids) {
  var services = [];
...
GattCentral.prototype.discoverIncludedServices = function(serviceUuid, uuids) {
...
GattCentral.prototype.discoverCharacteristics = function(serviceUuid, characteristicUuids) {
  var service = this._services[serviceUuid];
  var characteristics = [];
...
GattCentral.prototype.read = function(serviceUuid, characteristicUuid) {
...
GattCentral.prototype.write = function(serviceUuid, characteristicUuid, data, withoutResponse) {
  var characteristic = this._characteristics[serviceUuid][characteristicUuid];
...
GattCentral.prototype.broadcast = function(serviceUuid, characteristicUuid, broadcast) {
  var characteristic = this._characteristics[serviceUuid][characteristicUuid];
...
GattCentral.prototype.notify = function(serviceUuid, characteristicUuid, notify) {
  var characteristic = this._characteristics[serviceUuid][characteristicUuid];
...
GattCentral.prototype.discoverDescriptors = function(serviceUuid, characteristicUuid) {
  var characteristic = this._characteristics[serviceUuid][characteristicUuid];
  var descriptors = [];
...
GattCentral.prototype.readValue = function(serviceUuid, characteristicUuid, descriptorUuid) {
...
GattCentral.prototype.writeValue = function(serviceUuid, characteristicUuid, descriptorUuid, data) {
  var descriptor = this._descriptors[serviceUuid][characteristicUuid][descriptorUuid];
...
GattCentral.prototype.readHandle = function(handle) {
...
GattCentral.prototype.writeHandle = function(handle, data, withoutResponse) {
  if (withoutResponse) {
