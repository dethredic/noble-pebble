...
var CharacteristicCentral = require('./characteristic_central');
var CharacteristicPeripheral = require('./characteristic_peripheral');
...
Noble.prototype.PrimaryService = PrimaryService;
Noble.prototype.CharacteristicCentral = CharacteristicCentral;
Noble.prototype.CharacteristicPeripheral = CharacteristicPeripheral;
Noble.prototype.Descriptor = Descriptor;
...
Noble.prototype.onServicesSet = function(error) {
  debug('servicesSet');
...
Noble.prototype.onCharacteristicsDiscover = function(peripheralUuid, serviceUuid, characteristics) {
  ...
  if (service) {
    ...
    for (var i = 0; i < characteristics.length; i++) {
      ...
      var characteristic = new CharacteristicCentral(
                                this,
                                peripheralUuid,
                                serviceUuid,
                                characteristicUuid,
